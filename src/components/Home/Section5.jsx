...
const Section5 = () => {
  ...
  // };
    return (
        ...
        <div class="item">
            <h4><img alt="JAK's" src="https://i0.wp.com/www.nepalcanmove.com/wp-content/uploads/2022/01/Logo-Jacks-Fashion.jpg?fit=677%2C671&ssl=1" style={{width: '200px', height: '200px'}} /></h4>
        </div>
        <div class="item">
            <h4>
